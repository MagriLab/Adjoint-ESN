...
model_paths = [
    Path(
        "local_results/rijke/run_20231029_153121_noise_5_new"
    ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 5% noise
    Path(
        "local_results/rijke/run_20231029_153121_noise_5_tikh_5_new"
    ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 5% noise
    #    Path(
    #     "local_results/rijke/run_20231029_153121_noise_5_tikh_4_new"
    #     ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 5% noise
    Path(
        "local_results/rijke/run_20231029_153121_noise_5_tikh_3_new"
    ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 5% noise
    #         Path(
    #         "local_results/rijke/run_20231029_153121_noise_5_tikh_2_new"
    #         ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 5% noise
]
...
ts_paths = [
    "20240708_192719",  # tikh = 1e-6
    "20240708_193139",  # tikh = 1e-5
    # "20240708_193415", #tikh = 1e-4
    "20240708_193536"  # tikh = 1e-3
    # "20240708_195456" #tikh = 1e-2
]

lt_path_str = "long_term_beta_2_00_tau_0_25_results"
lt_paths = [
    "20240708_194126",  # tikh = 1e-6
    "20240708_194427",  # tikh = 1e-5
    # "20240708_194707", #tikh = 1e-4
    "20240708_195449"  # tikh = 1e-3
    # "20240708_193806" #tikh = 1e-2
]
