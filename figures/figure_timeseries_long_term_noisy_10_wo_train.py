...
save_fig = True
fig_name = "lco2_noisy_10_wo_train"

model_paths = [
    Path(
        "local_results/rijke/run_20231029_153121_noise_10"
    ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 10% noise
    Path(
        "local_results/rijke/run_20231029_153121_noise_10_tikh_5"
    ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 10% noise
    #    Path(
    #     "local_results/rijke/run_20231029_153121_noise_10_tikh_4"
    #     ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 5% noise
    Path(
        "local_results/rijke/run_20231029_153121_noise_10_tikh_3"
    ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 10% noise
    # Path(
    # "local_results/rijke/run_20231029_153121_noise_10_tikh_2"
    # ),  # rijke with reservoir, trained on beta = 1,2,3,4,5 + 5% noise
]
...
# ts_paths = ["20240707_171407",  #tikh = 1e-6
#             "20240707_162848",  #tikh = 1e-5
#             # "20240707_162926",  #tikh = 1e-4
#             "20240707_163227" #tikh = 1e-3
#             # "20240707_171220" #tikh = 1e-2
#             ]

# lt_path_str = "long_term_beta_2_00_tau_0_25_results"
# lt_paths = ["20240707_171642", #tikh = 1e-6
#             "20240707_163601", #tikh = 1e-5
#             # "20240707_163937", #tikh = 1e-4
#             "20240707_164210" #tikh = 1e-3
#             # "20240707_170746" #tikh = 1e-2
#             ]
...
ts_paths = [
    "20240707_184713",  # tikh = 1e-6
    "20240707_184631",  # tikh = 1e-5
    # "20240707_185145",  #tikh = 1e-4
    "20240707_184554",  # tikh = 1e-3
    # "20240707_185046" #tikh = 1e-2
]

lt_path_str = "long_term_beta_4_50_tau_0_12_results"
lt_paths = [
    "20240707_184739",  # tikh = 1e-6
    "20240707_182022",  # tikh = 1e-5
    # "20240707_185537", #tikh = 1e-4
    "20240707_181620",  # tikh = 1e-3
    # "20240707_185240" #tikh = 1e-2
]
...
for i in range(len(plt_idx)):
    ...
    vis.plot_phase_space(
        ...
        *[
        ...
        linestyle=[*linespecs["linestyle"]],
        linewidth=[*linespecs["linewidth"]],
...
train_len = pp.get_steps(config.train.time, network_dt)

for i in range(len(plt_idx)):
    ax = subfigs[2].add_subplot(len(plt_idx) + 1, 1, i + 1)
    omega, amp_spec = signals.get_amp_spec(
        network_dt,
        y_short[plt_loop_idx][:train_len, plt_idx[i]],  # y_long[:, plt_idx[i]],
        remove_mean=True,
        periodic=periodic,
    )
