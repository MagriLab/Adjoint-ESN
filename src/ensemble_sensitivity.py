...
def main(args):
    ...
    methods = ["adjoint"]  # "tangent linear", "adjoint", "finite difference"
    dJdp = {"true": {}, "esn": {}}
            ...
            for loop_time_idx, test_loop_time in enumerate(test_loop_time_arr):
                ...
                for loop_idx in range(n_loops):
                    ...
                    for method_name in methods:
                        ...
                        elif method_name == "finite difference":
                            dJdp["true"][method_name][
                                p_idx, :, loop_idx, loop_time_idx
        ...
        if args.get_adjoint_of == "both" or args.get_adjoint_of == "esn":
            for esn_idx in range(n_ensemble):
                ...
                if args.same_washout == True:
                    ...
                    X_tau_1_fin = X_past[-my_ESN.N_tau - 2 :, :]
                    P_new = np.vstack(
                        (
                    ...
                    X_tau_1_fin = X_pred[
                        N_transient_test - my_ESN.N_tau - 2 : N_transient_test, :
                    ]
                ...
                for loop_time_idx, test_loop_time in enumerate(test_loop_time_arr):
                    ...
                    X_tau_fin = X_tau_1_fin  # reset X_tau
