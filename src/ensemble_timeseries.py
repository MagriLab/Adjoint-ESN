...
def main(args):
    ...
    # get data
    test_sim_time = transient_time + np.sum(args.loop_times) + washout_time * n_loops
...
if __name__ == "__main__":
    ...
    parser.add_argument("--loop_times", nargs="+", type=float, default=[20])
