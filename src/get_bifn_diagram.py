...
beta_list = np.arange(4.0, 10.5, 0.5)
tau_list = [0.22]
...
for model_idx, model_path in enumerate(model_paths):
    ...
    plt_idx_arr = [eOutputVar.mu_1, eOutputVar.mu_2, eOutputVar.mu_3, eOutputVar.mu_4]
    ...
    for model_idx in range(n_models):
        for e_idx in range(n_ensemble):
            ...
            u_f_pred = Rijke.toVelocity(
                N_g, y_pred_long[:, eOutputVar.eta_1 : eOutputVar.eta_1 + N_g], x=0.2
            )[:, 0]
